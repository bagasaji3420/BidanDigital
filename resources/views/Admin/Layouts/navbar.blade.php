             ...
             <li class="nav-item navbar-dropdown dropdown-user dropdown">
                 <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);"
                     ...
                     <div class="avatar avatar-online">
                         <img onerror="this.onerror=null; this.src='{{ asset('assets/img/avatars/21.jpg') }}';"
                             src="{{ auth()->user()->avatar_url }}" class="rounded-circle" loading="lazy" />
                     </div>
                 </a>
                 <ul class="dropdown-menu dropdown-menu-end">
                         ...
                         <a class="dropdown-item" href="pages-account-settings-account.html">
                             <div class="d-flex">
                                 <div class="shrink-0 me-3">
                                     <div class="avatar avatar-online">
                                         <img onerror="this.onerror=null; this.src='{{ asset('assets/img/avatars/21.jpg') }}';"
                                             src="{{ auth()->user()->avatar_url }}" alt class=" rounded-circle"
                                             loading="lazy" />
                                     </div>
                                 </div>
                                 <div class="grow">
                     ...
                     <li>
                         <a class="dropdown-item" href="/">
                             <i class="icon-base bx bx-home icon-md me-3"></i><span>Homepage</span>
                         </a>
                     </li>
                     <li>
                         <div class="dropdown-divider my-1"></div>
